...
sklearn.model_selection for splitting data into train and test set  
sklearn.linear_model to train our model using LinearRegression.

My Idea: 

Potentially, I can create different pickled model of each company from the stock prices csv. In my research, 
it seems that they are predicting information on one topic that have values such as the S&P 500 but we have multiple
companies with lots of information about their stock price.
